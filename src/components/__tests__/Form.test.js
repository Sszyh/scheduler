...
describe("Form", () => {
  ...
  it("validates that the student name is not blank", () => {
    ...
    const { getByText } = render(<Form interviewers={interviewers} onSave={onSave} interviewer={1}/>)
  ...
  //   /* 3. Click the save button */
  //   const onSave = jest.fn();
  //   const { queryByText } = render(<Form interviewers={interviewers} onSave={onSave} student="Lydia Miller-Jones" interviewer={interviewers[0].id}/>)
